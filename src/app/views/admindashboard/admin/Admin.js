...
//   //   fetchNotices();
//   // }, [apiUrl]);
//   // const { currentSession } = useContext(SessionContext); // Access the current session from context

//   // useEffect(() => {
//   //   const fetchNotices = async () => {
//   //     if (!currentSession) {
//   //       console.error("No session is currently selected");
//   //       return;
//   //     }

//   //     try {
//   //       // Fetch notices based on the current session
...
const Admin = () => {
  ...
  //         roles.map(async (role) => {
  //           const response = await axios.get(
  //             `${process.env.REACT_APP_API_URL.trim()}/api/users/${role}`
  //           );
