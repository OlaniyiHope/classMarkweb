...

  {
      ...
      const fetchData = async () => {
        try {
          const res = await axios.get(
            `https://hlhs-98d6f8c9ac3a.herokuapp.com/api/examlist`
          );
          setExam(res.data);
        } catch (err) {
          setError(err);
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const res = await axios.get(
            `https://hlhs-98d6f8c9ac3a.herokuapp.com/api/class`
          );
          setClasss(res.data);
        } catch (err) {
          setError(err);
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const res = await axios.get(
            `https://hlhs-98d6f8c9ac3a.herokuapp.com/api/subject`
          );
          setSubject(res.data);
        } catch (err) {
          setError(err);
